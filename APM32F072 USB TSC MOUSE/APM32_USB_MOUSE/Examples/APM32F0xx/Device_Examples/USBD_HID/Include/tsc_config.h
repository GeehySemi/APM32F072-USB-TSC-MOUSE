...
#define TOUCH_TSC_GROUP1_IO4  CHANNEL       //!< PA3
...
#define TOUCH_TSC_GROUP3_IO1  NU  //!< PC5
#define TOUCH_TSC_GROUP3_IO2  NU  //!< PB0
#define TOUCH_TSC_GROUP3_IO3  NU  //!< PB1
