...
void USBD_Config(USBD_HANDLE_T* usbdh)
{
    ...
    USBD_ConfigPMA(usbdh, USBD_EP0_OUT_ADDR, USBD_EP_BUFFER_SINGLE, USBD_EP0_OUT_SIZE);
    USBD_ConfigPMA(usbdh, USBD_EP0_IN_ADDR, USBD_EP_BUFFER_SINGLE, USBD_EP0_IN_SIZE);
}
